...
import com.jp.materialdesignsample.utils.MaterialDesignImageLoadingEvaluator;
...
public class MaterialImageView extends ImageView implements ValueAnimator.AnimatorUpdateListener {
    ...
    protected void initView(Context context) {
        ...
        MaterialDesignImageLoadingEvaluator mEvaluator = new MaterialDesignImageLoadingEvaluator();
